...
use backend\models\SliderTextSearch;
...
/**
 * SliderTextController implements the CRUD actions for SliderText model.
 */
class SliderTextController extends Controller
{
    ...
    /**
     * Creates a new SliderText model.
    ...
    /**
     * Updates an existing SliderText model.
